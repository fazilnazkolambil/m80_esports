              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    ...
                    subtitle: Text(selectedCafe,style: textStyle(false),),
                  ),
                ...
                leading: TabBar(
                    ...
                    tabs: List.generate(cafe[0][selectedCafe].length, (index) {
                      return Padding(
                        ...
                        child: Text(cafe[0][selectedCafe][index].keys.first,style: textStyle(true)),
                      );
                    })),
                centerTitle: true,
              ),
                                        ...
                                        boxShadow: [
                                          BoxShadow(
                                            color:setups[index]['status']
                                                ? ColorConst.errorAlert.withOpacity(0.3)
                                                : ColorConst.successAlert.withOpacity(0.3),
                                            blurRadius: 10,
                                            spreadRadius: 2,
                                          )
                                        ]
                                                        ...
                                                        return SizedBox(
                                                          ...
                                                          child: Center(
                                                            child: Column(
                                                              ...
                                                              children: <Widget>[
                                                                Text('Bookings will be available soon!',style: textStyle(true)),
                                                              ],
                                                            ),
                                                          ),
                                                        );
